...
![版本](https://img.shields.io/badge/version-1.7-orange)
...
例如：輸入「UNO 潔顏慕絲」、「專科 潔顏慕絲」和「魔唇 護唇膏」，找出同時有賣這三樣的賣場，**合併購買達到免運門檻，省下多筆運費**。
...
> 第三張：取消勾選「魔唇 護唇膏」後重新搜尋，結果從 3 間擴展為 13 間賣場
...
5. 按「搜尋」，等待結果
6. 結果依賣場顯示，包含各商品價格、評分（含 1 星評價數）、已售數量、到貨時間，以及**合購估價**（由低至高排序）；賣場名稱旁會標示**商城**或**蝦皮優選**類型
...
- 每個關鍵字取蝦皮搜尋第一頁的結果進行比對；若找不到交集，可嘗試縮減關鍵字數量或調整關鍵字用詞
