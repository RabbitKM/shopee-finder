...
![版本](https://img.shields.io/badge/version-1.6-orange)
...
> 第三張：取消勾選「魔唇 護唇膏」後重新搜尋，結果從 3 間擴展為 14 間賣場
...
5. 按「搜尋」，等待結果
6. 結果依賣場顯示，包含各商品價格、評分、已售數量、到貨時間，以及**合購估價**（由低至高排序）；賣場名稱旁會標示**商城**或**蝦皮優選**類型
